      ...
      <div className="w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg">
        ...
        >
          ...
          <input
            ...
            className="p-2 border border-gray-500 text-black rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500"
          />
          <textarea
            ...
            required
            className="p-2 text-black border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500 "
            rows={4}
          ></textarea>
