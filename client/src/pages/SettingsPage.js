        ...
        <div className="h-full w-full bg-background relative overflow-y-auto flex items-center justify-center p-4" >
            ...
            <div className="bg-card/60 backdrop-blur-2xl border border-border rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl relative z-10 flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 border-b border-border flex items-center gap-4 bg-muted/20">
                    ...
                    <h1 className="text-xl font-bold text-foreground tracking-wide">Settings</h1>
                </div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="relative group">
                            ...
                            <img
                                ...
                                className="relative w-24 h-24 rounded-full object-cover border-4 border-card shadow-xl"
                                alt="Profile"
                            />
                        </div>
                        <h2 className="mt-4 text-2xl font-bold text-foreground">{authUser?.fullName}</h2>
                        <p className="text-muted-foreground text-sm">{authUser?.email}</p>
                    </div>

                    {/* Privacy Section */}
                    <div className="space-y-4">
                        <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-widest pl-2 border-l-2 border-violet-500">Privacy & Security</h3>
                        ...
                        <div className="bg-secondary/30 border border-border rounded-2xl p-4 flex items-center justify-between hover:bg-secondary/50 transition-colors">
                            <div className="flex items-start gap-3">
                                <div className="p-2 bg-secondary/80 rounded-lg text-violet-400">
                                    <Ghost size={20} />
                                </div>
                                <div>
                                    <p className="text-foreground font-medium text-base">Ghost Mode</p>
                                    <p className="text-muted-foreground text-xs mt-0.5">Hide your online status completely</p>
                                </div>
                            </div>
                            <button
                                onClick={() => handleToggle('ghostMode')}
                                className={`w-12 h-7 rounded-full transition-colors relative focus:outline-none focus:ring-2 focus:ring-violet-500/50 ${privacy.ghostMode ? 'bg-violet-600' : 'bg-muted'}`}
                            >
                        ...
                        <div className="bg-secondary/30 border border-border rounded-2xl p-4 flex items-center justify-between hover:bg-secondary/50 transition-colors">
                            <div className="flex items-start gap-3">
                                <div className="p-2 bg-secondary/80 rounded-lg text-indigo-400">
                                    <Clock size={20} />
                                </div>
                                <div>
                                    <p className="text-foreground font-medium text-base">Last Seen</p>
                                    <p className="text-muted-foreground text-xs mt-0.5">Allow others to see when you were active</p>
                                </div>
                            </div>
                            <button
                                onClick={() => handleToggle('lastSeen')}
                                className={`w-12 h-7 rounded-full transition-colors relative focus:outline-none focus:ring-2 focus:ring-violet-500/50 ${privacy.lastSeen ? 'bg-violet-600' : 'bg-muted'}`}
                            >
                        ...
                        <div className="bg-secondary/30 border border-border rounded-2xl p-4 flex items-center justify-between hover:bg-secondary/50 transition-colors">
                            <div className="flex items-start gap-3">
                                <div className="p-2 bg-secondary/80 rounded-lg text-blue-400">
                                    <CheckCircle size={20} />
                                </div>
                                <div>
                                    <p className="text-foreground font-medium text-base">Read Receipts</p>
                                    <p className="text-muted-foreground text-xs mt-0.5">Show blue ticks when messages are read</p>
                                </div>
                            </div>
                            <button
                                onClick={() => handleToggle('readReceipts')}
                                className={`w-12 h-7 rounded-full transition-colors relative focus:outline-none focus:ring-2 focus:ring-violet-500/50 ${privacy.readReceipts ? 'bg-violet-600' : 'bg-muted'}`}
                            >
                        ...
                        <div className="bg-secondary/30 border border-border rounded-2xl p-4 flex items-center justify-between hover:bg-secondary/50 transition-colors">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-foreground font-medium text-base">Undo Window</p>
                                    <p className="text-muted-foreground text-xs mt-0.5">Time limit to delete messages</p>
                                </div>
                            </div>
                ...
                <div className="p-6 border-t border-border bg-muted/20">
                    ...
                    <p className="text-center text-xs text-muted-foreground mt-4"> Changes affect your experience immediately</p>
                </div>
